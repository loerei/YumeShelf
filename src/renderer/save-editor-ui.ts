...
function getPanelHTML(d, popoutBtnHTML) {
    return `
...
function updateTabShadows(tabsContainer, leftShadow, rightShadow) {
...
function handleGlobalKeydown(e, overlay, state, engine, renderTabContent) {
