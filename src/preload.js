...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    loadTranslations: (lang) => ipcRenderer.invoke('save-editor:load-translations', lang),
    saveTranslations: (lang, translations) => ipcRenderer.invoke('save-editor:save-translations', { lang, translations }),
