...
This project is indexed by GitNexus as **YumeShelf** (4705 symbols, 8696 relationships, 272 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
