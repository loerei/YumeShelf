...
3. **启动**: 从桌面或开始菜单打开 梦之架 (YumeShelf)，然后选择现有的游戏文件夹，或者让 梦之架 为你创建一个。
4. **享受**: 双击任意游戏，开启你的旅程。

### 🛠️ 致开发者
欢迎！如果你想为 **梦之架 (YumeShelf)** 做出贡献，以下是技术架构简介。
...
3. **起動**: デスクトップまたはスタートメニューから ユメシェルフ を開き、既存のゲームフォルダを選択するか、ユメシェルフ に作成させます。
4. **楽しむ**: 任意のゲームをダブルクリックして旅を始めましょう。

### 🛠️ 開発者向け
ようこそ！**ユメシェルフ (YumeShelf)** に貢献したい方のために、技術的な詳細を説明します。
