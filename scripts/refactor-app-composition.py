"""
Refactor script: app-composition.js -> Replace flat refs with container refs.
Chạy: python scripts/refactor-app-composition.py
"""

import os

TARGET = os.path.join(os.path.dirname(__file__), '..', 'src', 'renderer', 'bootstrap', 'app-composition.js')

NEW_CONTENT = r"""import { createBootController } from '../boot.js';
...
print("     app-composition.js refactored to container-based model.")
