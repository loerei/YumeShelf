...
This project is indexed by GitNexus as **YumeShelf** (4538 symbols, 8222 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
